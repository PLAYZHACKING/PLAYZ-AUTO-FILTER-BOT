# Don't Remove Credit @PLAY-Z_Botz
...
ɪ ᴀᴍ ʟᴀᴛᴇꜱᴛ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀɴᴅ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ. ʏᴏᴜ ᴄᴀɴ ᴜꜱᴇ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ ᴇᴀʀɴ ᴜɴʟɪᴍɪᴛᴇᴅ ᴍᴏɴᴇʏ...💸.   created by - @PLAYZ_HACKING</b>"""
...
ʀᴇғᴇʀᴀʟ ʟɪɴᴋ - https://telegram.me/{}?start=PLAYZ-{}
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/PLAYZ_Hacking/3)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
★ Fʀᴇᴇ Sᴛᴏʀᴀɢᴇ: <code>{} MB</code></b>"""
    ...
    STATUS_TXT = """
<b>
╭━━━ ⚙️ <u>BOT STATUS PANEL</u> ━━━╮

┣ 📊 <b>GLOBAL STATS</b>
┃  ┗━ 📁 Total Files (All DBs) : <code>{}</code>

┣ 👥 <b>USERS DATABASE</b>
┃  ┣━ 👤 Total Users : <code>{}</code>
┃  ┗━ 💬 Total Chats : <code>{}</code>

┣ 🗄️ <b>FILE DATABASE — 1</b>
┃  ┣━ 📁 Total Files : <code>{}</code>
┃  ┣━ 🟢 Used Storage : <code>{} MB</code>
┃  ┗━ 🔵 Free Storage : <code>{} MB</code>

┣ 🗄️ <b>FILE DATABASE — 2</b>
┃  ┣━ 📁 Total Files : <code>{}</code>
┃  ┣━ 🟢 Used Storage : <code>{} MB</code>
┃  ┗━ 🔵 Free Storage : <code>{} MB</code>
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த PLAY-Z-FILTER-BOT போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 Step 1: Administer this PLAY-Z-FILTER-BOT bot to your group
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: ఈ PLAY-Z-FILTER-BOT బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس PLAY-Z-FILTER-BOT بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ PLAY-Z-FILTER-BOT બોટનું સંચાલન કરો
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই PLAY-Z-FILTER-BOT বট পরিচালনা করুন
